...
/// Configure the blocktime pallet in pallets/blocktime.
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		BlocktimeModule: pallet_blocktime::{Module, Call},
	}
);
...
impl_runtime_apis! {
	...
	// Here we implement our custom blocktime runtime API.
	impl pallet_blocktime_runtime_api::BlocktimeApi<Block> for Runtime {
		fn get_current_block_time() -> u32 {
			...
			// amalgamator file
			BlocktimeModule::get_current_block_time()
		}
	}
}
